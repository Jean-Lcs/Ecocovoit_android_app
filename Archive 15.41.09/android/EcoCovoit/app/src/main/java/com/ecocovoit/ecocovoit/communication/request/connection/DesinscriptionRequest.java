...
public class DesinscriptionRequest extends RequestFromConnectedUser {

    private User user;
    public static final String REQUEST_JSON_KEY_USER = "user";

    public DesinscriptionRequest(int token, User user) throws JSONException {
        super(token);
        this.user = user;
    }
    ...
    protected void fillJsonObject(JSONObject jsonObject) throws JSONException {
        jsonObject.put(REQUEST_JSON_KEY_USER, user.toJson());
    }
}
