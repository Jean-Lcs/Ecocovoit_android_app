...
public class JourneyRequest extends RequestFromConnectedUser {
    ...
    public JourneyRequest(int token, Location startLocation, Date startTime, Location endLocation, Date endTime) throws JSONException {
        super(token);
